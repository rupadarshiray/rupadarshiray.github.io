...
> File: https://dub.sh/thesisms (The updated versions of the notes will be available in the same link.)
> For best viewing on mobile (with bookmarks): [open in pdf.js viewer](https://mozilla.github.io/pdf.js/web/viewer.html?file=https://rupadarshiray.github.io/notes/2508gg.pdf)
...
- topological
	...
	- [Proper maps between topological spaces](https://rupadarshiray.github.io/notes/sett.Top.map%20proper.pdf)
	- [When is a local homeomorphism between topological spaces a covering map](https://rupadarshiray.github.io/notes/sett.Top.map%20when%20loc%20homeo%20is%20covering.pdf)
	- [When is a local homeomorphism between topological spaces a closed map](https://rupadarshiray.github.io/notes/sett.Top.map%20when%20local%20homeo%20is%20closed.pdf)
	- [When does a map between topological spaces send discrete sets to discrete sets](https://rupadarshiray.github.io/notes/sett.Top.map%20discrete%20to%20discrete.pdf)
	- $Y^{X}$ (coming soon!)
	- groups
