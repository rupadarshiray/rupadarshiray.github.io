...
| --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ----------------------------------------------------------------------------- |
| Metric spaces $X$ $\leftrightarrow$ rings of continuous functions $\mathcal{C}(X)$                                                            | only Sem 5 courses                      | the whole philosophy, the course on Rings and modules, the course on topology |
| Banach algebras and $\mathsf{c*}$-algebras                                                                                                    | courses upto Sem 7                      | LoHS                                                                          |
| smooth manifolds $X$ and $\mathcal{C}^{\infty}(X)$                                                                                            | smooth manifolds from Sem 7             |                                                                               |
| "smooth $\R$-algebras"                                                                                                                        |                                         |                                                                               |
